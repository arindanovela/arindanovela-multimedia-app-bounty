   ...
   <div className="App">
    ...
    <div style={styles.container}>
     ...
     <div style={styles.controlTools}>
        ...
        style={styles.inputSearch}  placeholder='Search' type="text"  />
        <button style={styles.controlButton} onClick={() => handleFilter('audio')}>Audio</button>
        <button style={styles.controlButton}  onClick={() => handleFilter('video')}>Video</button>
        <button style={styles.controlButton}  onClick={() => handleFilter('document')}>Document</button>
        <button style={styles.controlButton}  onClick={() => handleFilter('image')}>Image</button>
        <button style={styles.controlButton}  onClick={() => handleFilter('')}>Reset</button>
      </div>
     <div style={styles.controlTools}>
